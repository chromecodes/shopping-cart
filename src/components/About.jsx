...
const About = () => {
  return (
    <>
      <div className='home text-slate-100 h-screen w-screen bg-cover bg-[url("./assets/bgs/bgA.png")] '>
        <div className='glasses w-full h-full grid grid-cols-4 grid-rows-4'>
          <div className='leftAt row-span-4 flex flex-col items-center text-4xl'>
            ...
            <div className='block w-full h-1/4 text-2xl'>
              <div className='frost w-full h-full p-5 flex justify-center items-end'>
                <div className='links  flex gap-x-1.5'>
                  The{" "}
                  <a
